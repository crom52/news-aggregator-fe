const FeedUrlGid = (() => {
            ...
            on: {
              onItemClick: () => {
                ...
                if (multi) {
                  ...
                  removeData = removeData.filter((e) => e.feedUrl);
                } else {
                  text = 'Do you want to remove this item ?';
                  removeData.feedUrl ? removeData : null;
                }
  ...
  const layoutFeedUrlGrid = {
    view: 'scrollview',
    scroll: 'xy',
    body: { rows: [multiAddLayout, toolbar, grid] },
  };
  const manualEditor = {
    view: 'window',
    close: true,
